...
om2 = net_sigmoid_approx_more.layers[1].forward_propagation_more(o1)
om3 = net_sigmoid_approx_more.layers[2].forward_propagation_more(o2)
om4 = net_sigmoid_approx_more.layers[3].forward_propagation_more(o3)
